...
while exitChoice != "EXIT":
	...
	if playerChoice == "1":
		...
		print("1) Try to steal some dragon's gold.")
		print("2) Try to sneak around the dragon to exit.")
		dragonChoice = input("Which will it be? 1 or 2?...")
		if dragonChoice == "1":
		...
		exitChoice = input("Press enter to play again, or type EXIT to leave.")